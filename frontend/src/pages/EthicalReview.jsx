  ...
  return (
    <div>
      ...
      <main>
        ...
        <div className="items-center bg-blue-50 justify-center flex flex-col text-center py-16">
          <h1 className="font-secondary text-3xl text-primary font-bold p-5">
            Institutional Review Committee (IRC) - NNJS
          </h1>
          <div className="text-lg font-primary max-w-6xl mx-auto px-4 space-y-6 leading-relaxed">
            <p>
        ...
        <div className="grid gap-6 grid-cols-1 md:grid-cols-2 px-28 mb-18">
          {objectives.map((obj, idx) => (
            ...
            >
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3
                    className={`text-lg font-secondary font-semibold mb-1 ${
                      colorClasses[idx % colorClasses.length]
                    }`}
                  >
                    {obj.title}
        ...
        <div>
          ...
          <img
            ...
            className="w-1/3 max-w-1xl mx-auto my-10 mb-16"
          />
        </div>

        <div className="bg-blue-50 py-16 px-6 md:px-16">
          <h2 className="text-3xl font-bold font-secondary text-primary text-center mb-12">
            ...
            {faqs.map((faq, index) => (
              <div key={index} className="bg-white">
                <button
                  ...
                  className="w-full text-left py-5 px-6  text-gray-600 font-primary flex justify-between items-center border-b border-gray-200"
                >
                ...
                {openIndex === index && (
                  <div className="p-4 text-gray-600 font-primary border-b border-gray-300 leading-relaxed">
