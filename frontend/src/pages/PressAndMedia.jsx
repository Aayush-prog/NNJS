    ...
    <div>
      ...
      <main>
        ...
        >
          ...
          <div className="relative z-10 text-white text-center space-y-10 max-w-4xl px-4">
        ...
        <section id="news-section" className="py-16 px-4 bg-gray-50">
                  ...
                  {currentArticles.map((article) => (
                    ...
                    >
                      ...
                      <div className="p-6">
                        ...
                        <a
                          href={article.link}
                          className="text-primary font-medium hover:text-accent transition-colors duration-300 inline-flex items-center"
                        >
        ...
        {/* Press Releases */}
        <section id="releases-section" className="py-16 px-4">
          <div className="container mx-auto max-w-6xl">
            <motion.div
              variants={fadeInUp}
              initial="hidden"
            ...
            <div className="flex justify-center mb-8">
              <div className="inline-flex rounded-md shadow-sm">
                <button
                  onClick={() => {
                    setActiveFilter("all");
                    setReleaseCurrentPage(1); // Reset to first page when filter changes
                  }}
                ...
                <div className="space-y-4">
                  {currentReleases.map((release) => (
                    <motion.div
                      ...
                      whileInView="visible"
                      viewport={{ once: true, amount: 0.1 }}
                      className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 flex justify-between items-center"
                    >
                      <div>
        ...
        {/* Photo Gallery */}
        <section id="gallery-section" className="py-16 px-4">
          <div className="container mx-auto max-w-6xl">
            <motion.div
              variants={fadeInUp}
              initial="hidden"
                  ...
                  {currentGalleryItems.map((item) => (
                    ...
                    >
                      ...
                      <div className="absolute inset-0 bg-black bg-opacity-0 group-hover:bg-opacity-30 transition-opacity duration-300 flex items-center justify-center">
                        <span className="text-white opacity-0 group-hover:opacity-100 transition-opacity duration-300 font-bold">
                          {item.title}
                        </span>
                      </div>
                    </motion.div>
