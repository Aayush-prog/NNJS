...
export default function ObjectivesSection() {
  ...
  return (
    <motion.div
      ...
      className="py-18 px-4 sm:px-6 lg:px-8 bg-blue-50"
    >
          ...
          {objectives.map((obj, index) => (
            ...
            >
              <div className="flex items-start gap-4 ">
                <div
                  className={`icon-wrapper ${obj.bg} rounded-full flex items-center justify-center w-[50px] h-[50px]`}
                >
                  {obj.icon}
                </div>
              ...
              <p className="text-gray-600 pl-14 font-primary">
                {obj.description}
              </p>
            </motion.div>
          ))}
